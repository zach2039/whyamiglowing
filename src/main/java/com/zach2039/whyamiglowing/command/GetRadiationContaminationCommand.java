...
public class GetRadiationContaminationCommand {
	...
	static ArgumentBuilder<CommandSourceStack, ?> register() {
		return Commands.literal("get_contamination").requires((sourceStack) -> sourceStack.hasPermission(4))
	...
	private static int execute(final CommandContext<CommandSourceStack> context, final Entity entity) throws CommandSyntaxException {
		...
		context.getSource().sendSuccess(
				Component.translatable(
						WhyAmIGlowingLang.MESSAGE_CONTAMINATION_GET.getTranslationKey(),
